...
> Portions of this code were incorporated and adapted with permission from [Statistics Breadcrumbs](https://gitlab.com/oasci/dm) by OASCI licensed under the [MIT license](https://gitlab.com/oasci/breadcrumbs/stats/-/blob/main/LICENSE_CODE.md).
...
> Some content was incorporated and adapted with permission [Statistics Breadcrumbs](https://gitlab.com/oasci/dm) by OASCI licensed under the [CC BY-NC-SA 4.0 license](https://creativecommons.org/licenses/by-nc-sa/4.0/)
